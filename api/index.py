...
vn_trades = initialize_vanna("VANNA_MODEL_TRADES", "VANNA_API_KEY_TRADES", './database/TronForumData')

# Initialize Vanna for forum
vn_forum = initialize_vanna("VANNA_MODEL_FORUM", "VANNA_API_KEY_FORUM", './database/TronForumData')
